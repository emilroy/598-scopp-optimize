...
if mode == "map":
    ...
    with open("LargeLafayetteFLood/time_per_data.pkl", 'rb') as f:
        time_per_data1 = pickle.load(f)
    with open("LargeLafayetteFLood/tasks_data.pkl", 'rb') as f:
        tasks_data1 = pickle.load(f)
    total_completion_time1 = np.load("LargeLafayetteFLood/total_mission_completion_time.npy")
    path_planning_time1 = np.load("LargeLafayetteFLood/total_computation_time.npy")

    with open("MediumLafayetteFlood/time_per_data.pkl", 'rb') as f:
        time_per_data2 = pickle.load(f)
    with open("MediumLafayetteFlood/tasks_data.pkl", 'rb') as f:
        tasks_data2 = pickle.load(f)
    total_completion_time2 = np.load("MediumLafayetteFlood/total_mission_completion_time.npy")
    path_planning_time2 = np.load("MediumLafayetteFlood/total_computation_time.npy")
