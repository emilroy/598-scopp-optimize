...
# Load parameters
parameters = tap.LargeLafayetteFLood()
...
plt.axis([-250, 3000, 2850, max_y - 5])
plt.axis("off")
ax.imshow(map_png, extent=[-250, 3000, 2850, max_y - 5], origin="lower")
...
# Save as GIF
imageio.mimsave(save_path + "coverage.gif", image_list, fps=20)
print("Simulation complete. GIF saved to:", save_path + "coverage.gif")
